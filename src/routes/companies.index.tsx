      ...
      <main className="mx-auto max-w-7xl px-4 py-8">
        ...
        <div className="mt-6 flex flex-wrap gap-2">
          <select
            ...
            className="w-full sm:w-auto rounded-xl border border-border bg-card px-4 py-2.5 text-sm font-medium hover:border-brand focus:border-brand focus:ring-1 focus:ring-brand"
          >
