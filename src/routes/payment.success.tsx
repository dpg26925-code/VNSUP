    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="mx-auto max-w-lg px-4 py-20 text-center">
        ...
        <div className="mt-8 flex justify-center gap-3">
          <Link to="/dashboard/subscriptions" search={{ plan: undefined }} className="rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground hover:bg-primary/90">
            Xem gói của tôi
          </Link>
